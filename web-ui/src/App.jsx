...
function App() {
    ...
    return (
        <div className={`min-h-screen bg-[var(--bg-dark)] transition-colors duration-500 overflow-x-hidden relative`}>
            ...
            <footer className="py-8 border-t border-[var(--glass-border)] text-center text-[var(--text-secondary)] backdrop-blur-md relative z-10">
                <p className="flex items-center justify-center gap-2 text-sm font-medium tracking-wide hover:text-[var(--accent-primary)] transition-colors duration-300">
                    © 2026 CardioCare AI <span className="text-[var(--glass-border)]">|</span>
                    Developed with <Heart className="w-4 h-4 text-[var(--accent-secondary)] animate-pulse" fill="currentColor" /> by <span className="text-[var(--accent-primary)] font-bold">Anjali</span>
                </p>
            </footer>
        </div>
    );
